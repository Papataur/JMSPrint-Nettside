    ...
    <main className="page">
      <section className="hero">
        <div className="heroGrid">
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
            <div className="brand">JMSPrint</div>
            ...
            <p className="lead">
              Vi designer og 3D-printer praktiske produkter, smådeler og spesialløsninger for folk som liker smarte idéer, hobbyprosjekter og ting som faktisk fungerer.
            </p>
      ...
      <section id="produkter" className="section">
        <div className="sectionIntro">
          ...
          <span>Vi lager praktiske og kreative 3D-printede produkter — fra hobbytilbehør til smarte løsninger for hjem, garasje, båt og teknologi.</span>
        </div>
      ...
      <section id="kontakt" className="contact">
        ...
        <p>Send oss en skisse, et bilde eller en forklaring — så ser vi om vi kan lage det med 3D-print.</p>
